    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ get_static_option('current_membership_modal_title') ?? __('Informations sur l\'abonnement actuel') }}</h1>
                        ...
                        <div class="memberDetails">
                            ...
                            <div class="infoSingleTwo d-flex gap-3 mt-4 justify-content-md-between">
                                ...
                                <div class="left_part">
                                    ...
                                    <div class="row_1 d-flex gap-1">
                                        ...
                                        <div class="col_2">
                                          <small>{{ __('Disponible') }}</small> {{ $user_membership->listing_limit }}
                                        </div>
                                    </div>
                                    <!--single items -->
                                    <div class="row_1 d-flex gap-1">
                                        <div class="col_1">
                                            {{ __('Images de galerie par annonce') }}
                                        </div>
                                        <div class="col_2">
                                            <small>{{ __('Disponible') }}</small> {{ $user_membership->gallery_images }}
                                        </div>
                                    </div>
                                    <!--single items -->
                                    <div class="row_1 d-flex gap-1">
                                        <div class="col_1">
                                            {{ __('Limite d\'annonces en vedette') }}
                                        </div>
                                        <div class="col_2">
                                            <small>{{ __('Disponible') }}</small> {{ $user_membership->featured_listing }}
                                        </div>
                                    </div>
                                </div>
                            ...
                            @else
                                <div class="chat_wrapper__details__inner__chat__contents">
                                    <h2 class="btn btn-info"> {{ __('Aucun plan d\'abonnement trouvé') }}</h2>
                                </div>
                            @endif
                        </div>
                    </div>
