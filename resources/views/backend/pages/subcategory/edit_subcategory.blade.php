...
@section('content')
    ...
    <select name="code" id="code" class="select2_activation radius-5">
        <option value="0" {{ $subcategory->code == 0 ? 'selected' : '' }}>{{ __('Selectionner le code') }}</option>
        <option value="1" {{ $subcategory->code == 1 ? 'selected' : '' }}>Immobilier</option>
        <option value="2" {{ $subcategory->code == 2 ? 'selected' : '' }}>Service</option>
        <option value="3" {{ $subcategory->code == 3 ? 'selected' : '' }}>Occasion</option>
        <option value="4" {{ $subcategory->code == 4 ? 'selected' : '' }}>Car</option>
    </select>
</div>
