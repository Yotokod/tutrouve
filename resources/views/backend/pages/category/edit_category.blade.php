...
<div class="form__input__single">
    ...
    <select name="code" id="code" class="select2_activation radius-5">
        <option value="0" {{ $category->code == 0 ? 'selected' : '' }}>{{ __('Selectionner le code') }}</option>
        <option value="1" {{ $category->code == 1 ? 'selected' : '' }}>Immobilier</option>
        <option value="2" {{ $category->code == 2 ? 'selected' : '' }}>Service</option>
        <option value="3" {{ $category->code == 3 ? 'selected' : '' }}>Occasion</option>
        <option value="4" {{ $category->code == 4 ? 'selected' : '' }}>Car</option>
    </select>
</div>
