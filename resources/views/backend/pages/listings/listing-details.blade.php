                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-xxl-4 col-lg-4">
                                <div class="dashboard_orderDetails__sidebar__item">
                                    <div class="right-content">
                                        <h4 class="header-title mb-2">{{ get_static_option('listing_attribute_section_title') ?? __('Attributes') }}</h4>
                                    </div>
                                    @foreach($listing->listing_attributes as $attribute)
                                        <div class="dashboard_orderDetails__sidebar__data">
                                            <p class="dashboard_orderDetails__sidebar__left">
                                                {{ $attribute->title }}
                                                <span class="dashboard_orderDetails__sidebar__left__para"> <strong>{{ $attribute->description }}</strong> </span>
                                            </p>
                                        </div>
                                    @endforeach
                                </div>
