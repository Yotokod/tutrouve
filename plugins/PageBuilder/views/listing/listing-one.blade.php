...
<div class="all-listing" data-padding-top="{{$padding_top}}" data-padding-bottom="{{$padding_bottom}}">
    ...
    @foreach($listings_top as $listing)
                                    ...
                                    <div class="single-category-service">
                                        <div class="single-select">
                                            <input type="text" class="search-input form-control" id="search_by_query"
                                                   placeholder="Rechercher par le nom" name="q" value="{{$text_search_value}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="catagoriesWraper mb-4">
                                    <div class="catagories w-100">
                                            ...
                                            <div class="cancel_apply_section_start text-end mb-2">
                                                <button type="button" class="filter-btn w-100" id="distance_wise_filter_apply">{{ __('Filtrer') }}</button>
                                            </div>
                                    </div>
                                </div>
                            @endif
                        ...
                        @if(!empty($price_range_on_off))
                            <div class="catagoriesWraper mb-4">
                                <div class="catagories priceRange">
                                    <h5 class="cateTitle mb-2 postdateTitle">{{ __('Filtrer par prix (FCFA)') }}</h5>
                                    <input type="hidden" name="price_range_value" id="price_range_value">
                                    <div class="price-input">
                                        <div class="field">
                                            <div class="min_price_range priceRangeWraper">
                                              <!--price range filter   <span class="site_currency_symbol">{{ site_currency_symbol() }}</span>-->  
                                    ...
                                    <div class="cancel_apply_section_start mt-3">
                                        <button type="button" class="filter-btn w-100" id="price_wise_filter_apply">{{ __('Filtrer') }}</button>
                                    </div>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="catagoriesWraper mb-4">
                                <div class="catagories">
                                    ...
                                    <ul class="postdate">
                                        ...
                                        <li @if($listing_type_preferences_value == 'top_listing') class="active" @endif><a href="javascript:void(0)" id="top_listing">{{ __('Populaire') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        @endif
                        ...
                        @if(!empty($listing_condition))
                            <div class="catagoriesWraper mb-4">
                                <div class="catagories">
                                    ...
                                    <ul class="postdate">
                                        <li @if($listing_condition_value == 'new') class="active" @endif><a href="javascript:void(0)" id="new">{{ __('Neuf') }}</a></li>
                                        <li @if($listing_condition_value == 'used') class="active" @endif><a href="javascript:void(0)" id="used">{{ __('Occasion') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        @endif
                        ...
                        @if(!empty($date_posted))
                            <div class="catagoriesWraper mb-4">
                                <div class="catagories">
                                    ...
                                    <ul class="postdate">
                                        <li @if($date_posted_value == 'today') class="active" @endif><a href="javascript:void(0)" id="today">{{ __('Aujourd\'hui') }}</a></li>
                                        <li @if($date_posted_value == 'yesterday') class="active" @endif><a href="javascript:void(0)" id="yesterday">{{ __('Hier') }}</a></li>
                                        <li @if($date_posted_value == 'last_week') class="active" @endif><a href="javascript:void(0)" id="last_week">{{ __('La semaine passé') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        @endif
                                        ...
                                        <div class="SearchWrapper d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="views align-items-center">
                                                ...
                                                <div class="reset-btn cmn-filter-btn">
                                                    <a href="{{ url()->current() }}">
                                                        <button type="button">
                                                            <i class="las la-undo-alt"></i> {{ __('Réinitialiser le filtre') }}
                                                        </button>
                                                    </a>
                                                </div>
