<table class="dataTablesExample">
    ...
    <th>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-listing-approved')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status.all-status-change','data' => ['url' => route('admin.listings.user.all.approved')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.listings.user.all.approved'))]); ?>
...
<?php endif; ?>
            ...
            <td><?php echo e(optional($data->user)->fullname); ?></td>
            <td>
                <strong class="subCap"><?php echo e($data->created_at->diffForHumans()); ?></strong>
            </td>
            <!--Publish -->
            <td>
                <?php echo e($data->is_published == 1 ? \Carbon\Carbon::parse($data->published_at)->format('F j, Y') : __('Not published')); ?>
...
<?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-listing-delete')): ?>
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/listings/search-listing.blade.php ENDPATH**/ ?>