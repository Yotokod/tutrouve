...
<div class="favourite-icon <?php echo e($user_add_item); ?>">
    <a href="javascript:void(0)" class="click_to_favorite_add_remove"
       data-listing_id="<?php echo e($favorite); ?>">
        <i class="lar la-heart icon <?php echo e($iconClass); ?>"></i>
    </a>
</div>
<?php /**PATH /home/tutreqhl/beta.tutrouve.com/core/resources/views/components/listings/favorite-item-add-remove.blade.php ENDPATH**/ ?>