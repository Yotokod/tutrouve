            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between mb-3">
                    ...
                    <div class="right-content">
                        <a class="cmnBtn btn_5 btn_bg_info radius-5" href="<?php echo e(route('admin.child.category')); ?>"><?php echo e(__('All Child Categories')); ?></a>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.child.category.new')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form__input__flex">
                        <div class="form__input__single">
                            <label for="category" class="form__input__single__label"> <?php echo e(__('Select Parent Category')); ?> <span class="text-danger">*</span> </label>
                        ...
                        <div class="form__input__single">
                            <label for="subcategory" class="form__input__single__label"> <?php echo e(__('Select Sub Category')); ?> <span class="text-danger">*</span> </label>
                        ...
                        <div class="form__input__single">
                            <label for="name" class="form__input__single__label"><?php echo e(__('Child Category')); ?></label>
                            <input type="text" class="form__control radius-5" name="name" id="name" placeholder="<?php echo e(__('Child Category Name')); ?>">
                        </div>
                        <div class="form__input__single permalink_label">
                            <label class="form__input__single__label"><?php echo e(__('Permalink * :')); ?>
                        ...
                        <div class="form__input__single">
                            <label for="image" class="form__input__single__label"><?php echo e(__('Upload Child Category Image')); ?></label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/child-category/add_child_category.blade.php ENDPATH**/ ?>