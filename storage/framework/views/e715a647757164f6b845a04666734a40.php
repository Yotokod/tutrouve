<table class="dataTablesExample">
    ...
    <th>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('guest-listing-all-approved')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status.all-status-change','data' => ['url' => route('admin.listings.guest.all.approved')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.listings.guest.all.approved'))]); ?>
...
<?php endif; ?></span>
    ...
    <tbody>
    <?php $__currentLoopData = $all_guest_listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('guest-listing-bulk-delete')): ?>
            <td>
...
<?php endif; ?>
            ...
            <td><?php echo e(optional($data->guestListing)->guestfullname); ?></td>
            <td>
            ...
            <td>
               ...
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-listing-published-status-change')): ?>
                <span class="my-2">
                    <?php if (isset($component)) { $__componentOriginal61d050719602bebe53e2163e2703f820 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal61d050719602bebe53e2163e2703f820 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status.admin-listing-published-change','data' => ['url' => route('admin.listings.published.status.change',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.listings.published.status.change',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <td>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-listing-status-change')): ?>
                <span class="my-2">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status.status-change','data' => ['url' => route('admin.listings.status.change',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.listings.status.change',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('guest-listing-delete')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.popup.delete-popup','data' => ['url' => route('admin.guest.listings.delete', $data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.guest.listings.delete', $data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<div class="custom_pagination mt-5 d-flex justify-content-end">
    <?php echo e($all_guest_listings->links()); ?>

</div>
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/listings/guest-listings/search-listing.blade.php ENDPATH**/ ?>