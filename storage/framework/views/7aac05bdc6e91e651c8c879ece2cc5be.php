        ...
        $(document).ready(function(){
            ...
            $(document).on('submit','#edit_profile_form',function(e){
                ...
                if(first_name == '' || last_name == '' || email == '' || country == ''){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('user.profile.edit')); ?>",
                        type: 'post',
                        data: {
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/frontend/user/profile/account-settings-js.blade.php ENDPATH**/ ?>