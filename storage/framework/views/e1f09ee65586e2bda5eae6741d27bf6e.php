                ...
                <form action="<?php echo e(route('admin.login.register.page.settings')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <!--register page start -->
                        ...
                        <div class="form__input__single mb-3">
                            <label for="register_page_description" class="form__input__single__label"><?php echo e(__('Register Page Description')); ?></label>
                            <input type="text" name="register_page_description"  class="form-control" value="<?php echo e(get_static_option('register_page_description')); ?>" id="register_page_description">
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image.image','data' => ['title' => __('Register Page Image'),'name' => 'register_page_image','dimentions' => '160x50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Register Page Image')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('register_page_image'),'dimentions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('160x50')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/page-settings/login-register-settings.blade.php ENDPATH**/ ?>