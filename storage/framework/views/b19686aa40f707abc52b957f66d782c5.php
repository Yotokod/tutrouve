    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.user.paginate.data').'?page='); ?>" + page,
                    success:function(res){
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/user/users/user-js.blade.php ENDPATH**/ ?>