<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Add New Subcategory')); ?>
            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between">
                    <div class="left-content">
                        <h4 class="header-title"><?php echo e(__('Add New Subcategory')); ?>   </h4>
                    </div>
                    <div class="right-content">
                        <a class="cmnBtn btn_5 btn_bg_blue radius-5" href="<?php echo e(route('admin.subcategory')); ?>"><?php echo e(__('All Subcategory')); ?></a>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.subcategory.new')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form__input__flex">
                        ...
                        <div class="form__input__single">
                            <label for="category_id" class="form__input__single__label"><?php echo e(__('Parent Category')); ?></label>
                        ...
                        <div class="form__input__single">
                            <label for="name" class="form__input__single__label"><?php echo e(__('Sub Category')); ?></label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/subcategory/add_subcategory.blade.php ENDPATH**/ ?>