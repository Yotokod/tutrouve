        ...
        <div class="modal-content" style="height:92%;">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link " id="upload_media_image"
                                data-bs-toggle="tab"
                               href="#upload_files" role="tab" aria-selected="false"><?php echo e(__('Upload Files')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active"
                               data-bs-toggle="tab"
                               href="#media_library" role="tab" id="load_all_media_images" aria-controls="media_library" aria-selected="true"><?php echo e(__('Media Library')); ?></a>
                        </li>
                </ul>
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/components/media/markup.blade.php ENDPATH**/ ?>