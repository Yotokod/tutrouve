<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Admin All Listings')); ?>
                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title"><?php echo e(__('Admin All Listings')); ?></h4>
...
<?php endif; ?>
                        ...
                        <div class="dashboard__inner__header__right">
                            <div class="btn-wrapper">
                                <a href="<?php echo e(route('admin.add.new.listing')); ?>" class="cmnBtn btn_5 btn_bg_blue radius-5"><?php echo e(__('Add Listing')); ?></a>
                            </div>
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_notice_result">
                            <?php echo $__env->make('backend.pages.listings.admin-listings.search-listing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.bulk-action-js','data' => ['url' => route('admin.bulk.action.listing')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.bulk.action.listing'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        (function(){
            ...
            $(document).ready(function(){
                ...
                $(document).on('keyup','.notice_string_search',function(){
                    ...
                    $.ajax({
                        url:"<?php echo e(route('admin.search.listings')); ?>",
                        method:'GET',
                ...
                function notices(page){
                    $.ajax({
                        url:"<?php echo e(route('admin.paginate.listings').'?page='); ?>" + page,
                        success:function(res){
                            $('.search_notice_result').html(res);
                        }
                    });
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/listings/admin-listings/admin-all-listings.blade.php ENDPATH**/ ?>