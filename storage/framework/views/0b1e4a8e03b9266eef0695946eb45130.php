                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="upload_files" role="tabpanel" >
                        <div class="dropzone-form-wrapper">
                            <form action="<?php echo e(route($type. '.'.'guest.upload.media.file')); ?>" method="post" id="placeholderfForm" class="dropzone" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                            </form>
                        </div>
                    </div>
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/components/media/guest-markup.blade.php ENDPATH**/ ?>