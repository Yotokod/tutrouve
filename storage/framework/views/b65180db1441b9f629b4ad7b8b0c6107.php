    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function types(page,string_search){
                $.ajax({
                     url:"<?php echo e(route('admin.membership.type.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.membership.type.search')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
...
<?php /**PATH /home/tutreqhl/public_html/core/Modules/Membership/resources/views/backend/type/type-js.blade.php ENDPATH**/ ?>