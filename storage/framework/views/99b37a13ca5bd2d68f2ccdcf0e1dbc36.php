                    ...
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            <div class="btn-wrapper">
                                ...
                                <a class="cmnBtn btn_5 btn_bg_blue radius-5 btn-sm mb-3 mr-1" href="<?php echo e(route('admin.page')); ?>">
                                    <?php echo e(__('All pages')); ?>

                                </a>
                                <a class="cmnBtn btn_5 btn_bg_info radius-5 btn-sm mb-3 mr-1" target="_blank"
                                   href="<?php echo e(route('frontend.dynamic.page',$page->slug)); ?>">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/page-builder/dynamicpage.blade.php ENDPATH**/ ?>