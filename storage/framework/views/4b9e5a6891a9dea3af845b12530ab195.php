                ...
                <div class="tab-content" id="nav-tabContent8">
                    <div class="tab-pane fade show active" id="blog_meta" role="tabpanel" aria-labelledby="nav-21-tab">
                        <div class="form__input__flex mt-3">
                            <div class="form__input__single">
                                ...
                                <input type="text" class="form__control" name="meta_title" id="meta_title" value="<?php echo e($pagepost->meta_data->meta_title ?? ''); ?>" placeholder="<?php echo e(__('Title')); ?>">
                            </div>
                            <div class="form__input__single">
                                <label for="meta_tags" class="form__input__single__label"><?php echo e(__('Meta Tags')); ?></label>
                                <input type="text" class="form__control" name="meta_tags" id="meta_tags" value="<?php echo e($pagepost->meta_data->meta_tags ?? ''); ?>" data-role="tagsinput" placeholder="<?php echo e(__('Tag')); ?>">
                            </div>
                            <div class="form__input__single">
                                <label for="meta_description" class="form__input__single__label"><?php echo e(__('Meta Description')); ?></label>
                                <textarea class="form__control" name="meta_description"  cols="20" rows="4"><?php echo $pagepost->meta_data->meta_description ?? ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="facebook_meta" role="tabpanel" aria-labelledby="nav-22-tab">
                        <div class="form__input__single">
                            ...
                            <input type="text" class="form__control" value="<?php echo e($pagepost->meta_data->facebook_meta_tags ?? ''); ?>" data-role="tagsinput" name="facebook_meta_tags">
                        </div>
                        <div class="row">
                            <div class="form__input__single col-md-12">
                                ...
                                <textarea name="facebook_meta_description"  class="form__control max-height-140"  cols="20"  rows="4"><?php echo $pagepost->meta_data->facebook_meta_description ?? ''; ?></textarea>
                            </div>
                        </div>
                        <div class="form__input__single">
                            ...
                            <div class="media-upload-btn-wrapper">
                                ...
                                <input type="hidden" name="facebook_meta_image" value="<?php echo e($pagepost->meta_data->facebook_meta_image ?? ''); ?>">
                                <button type="button"
                    ...
                    <div class="tab-pane fade" id="twitter_meta" role="tabpanel" aria-labelledby="nav-22-tab">
                        <div class="form__input__single">
                            ...
                            <input type="text" class="form__control" value="<?php echo e($pagepost->meta_data->twitter_meta_tags ?? ''); ?>" data-role="tagsinput"  name="twitter_meta_tags">
                        </div>
                        <div class="row">
                            <div class="form__input__single col-md-12">
                                <label for="title"><?php echo e(__('Twitter Meta Description')); ?></label>
                                <textarea name="twitter_meta_description" class="form__control max-height-140" cols="20" rows="4"><?php echo $pagepost->meta_data->twitter_meta_description ?? ''; ?></textarea>
                            </div>
                        </div>
                        <div class="form__input__single">
                            ...
                            <div class="media-upload-btn-wrapper">
                                ...
                                <input type="hidden" name="twitter_meta_image" value="<?php echo e($pagepost->meta_data->twitter_meta_image ?? ''); ?>">
                                <button type="button"
                                        class="cmnBtn btn_5 btn_bg_blue radius-5 media_upload_form_btn"
                                        data-btntitle="<?php echo e(__('Select Image')); ?>"
                                        data-modaltitle="<?php echo e(__('Upload Image')); ?>"
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/components/backend/page-meta-data-edit.blade.php ENDPATH**/ ?>