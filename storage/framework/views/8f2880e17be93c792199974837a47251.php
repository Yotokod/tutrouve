    ...
    <div class="row g-3">
        ...
        <?php $__currentLoopData = $memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <div class="col-lg-4 col-sm-6">
                <div class="singlePrice <?php if(!empty($user_current_membership) && $user_current_membership->membership_id === $membership->id): ?> active <?php endif; ?>">
                        ...
                        <?php else: ?>
                            ...
                            <?php
                                    if(empty($user_current_membership)){
                                          $buttonText = __('Acheter maintenant');
                                     }else{
                                          $buttonText = __('Mettre à jour maintenant');
                                     }
...
<?php /**PATH /home/tutreqhl/public_html/core/Modules/Membership/resources/views/frontend/user/membership/user-dashboard-membership-plans.blade.php ENDPATH**/ ?>