<?php if($user_business_hour === true): ?>
    <?php
    ...
    ?>
    <?php if($business_hours_data): ?>
        <div class="business-hour box-shadow1">
            <h3 class="head5 business-head d-flex"><?php echo e(__('Business Hours')); ?> </h3>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/frontend/pages/listings/frontend-business-hours.blade.php ENDPATH**/ ?>