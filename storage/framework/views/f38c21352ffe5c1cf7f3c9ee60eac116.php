...
<?php endif; ?>
    <form action="<?php echo e(route('sliders.store')); ?>" method="POST" enctype="multipart/form-data" class="mt-4">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <a href="<?php echo e(route('sliders.index')); ?>" class="btn btn-secondary">Retour</a>
    </form>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/slider/create.blade.php ENDPATH**/ ?>