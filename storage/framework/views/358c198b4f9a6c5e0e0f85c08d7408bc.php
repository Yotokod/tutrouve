        ...
        (function ($){
            $(document).ready(function (){
                ...
                $(document).on('click', '.choose_membership_plan', function(e){
                    ...
                    let balance = <?php echo e(Auth::check() ? optional(Auth::user()->user_wallet)->balance ?? 0 : 0); ?>;

                    $('#membership_id').val(membership_id);
                    $('#membership_price').val(membership_price);

                    if(membership_price > balance){
                        $('.display_balance').html('<span class="text-danger"><?php echo e(__('Wallet Balance Shortage:')); ?>'+ site_default_currency_symbol + (membership_price-balance) +'</span>');
                        $('.deposit_link').html('<a href="#" target="_blank"><?php echo e(__('Deposit')); ?></a>');
                    }
                });
                ...
                $(document).on('click', '.login_to_buy_a_membership', function(e){
                    ...
                    erContainer.html('');
                    $.ajax({
                        url:"<?php echo e(route('membership.user.login')); ?>",
...
<?php /**PATH /home/tutreqhl/beta.tutrouve.com/core/resources/views/components/membership/membership-js.blade.php ENDPATH**/ ?>