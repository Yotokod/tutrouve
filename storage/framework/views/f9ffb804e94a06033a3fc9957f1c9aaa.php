<table class="dataTablesExample">
    <thead>
    <tr>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('membership-bulk-delete')): ?>
            <th class="no-sort">
        ...
        <th><?php echo e(__('Listings Limit')); ?></th>
        <th><?php echo e(__('Images Limit')); ?></th>
        <th><?php echo e(__('Featured listing Limit')); ?></th>
        <th><?php echo e(__('Enquiry Form')); ?></th>
        <th><?php echo e(__('Business Hour')); ?></th>
        <th><?php echo e(__('Membership Badge')); ?></th>
        <th><?php echo e(__('Status')); ?></th>
        <th><?php echo e(__('Action')); ?></th>
    </tr>
    </thead>
    <tbody>
    <?php $__currentLoopData = $all_memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('membership-bulk-delete')): ?>
...
<?php endif; ?> </td>
            ...
            <td><?php echo e($subs->membership_type?->type); ?></td>
            <td><?php echo e($subs->title); ?></td>
            <td><?php echo e(float_amount_with_currency_symbol($subs->price)); ?></td>
            <td><?php echo e($subs->listing_limit); ?></td>
            <td><?php echo e($subs->gallery_images); ?></td>
            <td><?php echo e($subs->featured_listing); ?></td>
            <td><?php echo e($subs->enquiry_form == 1 ? __('Allowed') : __('Not Allowed')); ?></td>
            <td><?php echo e($subs->business_hour == 1 ? __('Allowed') : __('Not Allowed')); ?></td>
            <td><?php echo e($subs->membership_badge == 1 ? __('Allowed') : __('Not Allowed')); ?></td>
            <td>
...
<?php endif; ?>
            ...
            <td>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('membership-edit')): ?>
                    <a href="<?php echo e(route('admin.membership.edit',$subs->id)); ?>" class="cmnBtn btn_5 btn_bg_blue btnIcon radius-5"><i class="las la-pen"></i></a>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('membership-status-change')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status.table.status-change','data' => ['url' => route('admin.membership.status',$subs->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.membership.status',$subs->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('membership-delete')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.popup.delete-popup','data' => ['url' => route('admin.membership.delete',$subs->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.membership.delete',$subs->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/tutreqhl/public_html/core/Modules/Membership/resources/views/backend/membership/search-result.blade.php ENDPATH**/ ?>