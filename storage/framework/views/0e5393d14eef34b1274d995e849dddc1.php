<?php if(!empty(get_static_option("google_map_settings_on_off"))): ?>
    <?php
     ...
     ?>
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(get_static_option("google_map_api_key")); ?>&libraries=places">
    ...
    <script>
        ...
        var places;
        var latitude = '<?php echo e($lat); ?>';
        var longitude = '<?php echo e($lon); ?>';
...
<?php endif; ?>
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/components/map/google-map-listing-details-page-js.blade.php ENDPATH**/ ?>