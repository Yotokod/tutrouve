    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $('#guest_first_name, #guest_last_name, #guest_email, #guest_phone, #guest_register_request').on('keyup change click', function() {
                if ($(this).is(':checked')) {
                    $.ajax({
                        url: "<?php echo e(route('guest.request.check')); ?>",
                        method: 'POST',
                        data: {
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/components/listings/guest-listing-ad-js.blade.php ENDPATH**/ ?>