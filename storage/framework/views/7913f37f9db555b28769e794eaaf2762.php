            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between mb-3">
                    ...
                    <div class="right-content">
                        <a class="cmnBtn btn_5 btn_bg_info radius-5" href="<?php echo e(route('admin.menu')); ?>"><?php echo e(__('All Menus')); ?></a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 mt-4">
                                <div class="menu-left-side-content">
                                    <h5 class="dashboard__card__header__title"><?php echo e(__('Add menu items')); ?></h5>
                                    <div class="accordion accordion-wrapper" id="add_menu_item_accordion">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="custom-links-content" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    <div class="form__input__single">
                                                        <label for="custom_url" class="form__input__single__label"><strong><?php echo e(__("URL")); ?></strong></label>
                                                        <input type="text" name="custom_url" id="custom_url" class="form-control" placeholder="<?php echo e(__('https://')); ?>">
                                                    </div>
                                                    <div class="form__input__single">
                                                        <label for="custom_label_text" class="form__input__single__label"><strong><?php echo e(__("Link Text")); ?></strong></label>
                                                        <input type="text" name="custom_label_text"  id="custom_label_text" class="form-control"  placeholder="<?php echo e(__('label text')); ?>">
                                                    </div>
                                                    <div class="form__input__single mt-2">
                                                        <button type="button" id="add_custom_links" class="cmnBtn btn_5 btn_bg_blue radius-5"><?php echo e(__('Add To Menu')); ?></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-8 col-lg-8 mt-4">
                                <div class="menu-structure-wrapper">
                                    <div class="card">
                                         <h5 class="dashboard__card__header__title mt-2 mb-2 mx-3"><?php echo e(__('Menu Structure')); ?></h5>
                                ...
                                <div class="form__input__single">
                                    <button type="submit" id="menu_structure_submit_btn" class="cmnBtn btn_5 btn_bg_blue radius-5 mt-3"><?php echo e(__('Update Changes')); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/menu/edit.blade.php ENDPATH**/ ?>