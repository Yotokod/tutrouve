...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb','data' => ['title' => '','innerTitle' => __('User Profile'),'subInnerTitle' => '','chidInnerTitle' => '','routeName' => '#','subRouteName' => '#']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('User Profile')),'subInnerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'chidInnerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'routeName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('#'),'subRouteName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('#')]); ?>
...
<?php endif; ?>
                                            ...
                                            <div class="member-listing">
                                                <span class="listing"><?php echo e($user->listings->count() ?? 0); ?> <?php echo e(__('listing')); ?> </span>
                                                <span class="dot">&middot;</span> <?php echo e(__('Member since')); ?> <?php echo e(optional($user->created_at)->format('Y')); ?>
                                    ...
                                    <div class="seller-ratings">
                                        ...
                                        <div class="rating-btn">
                                            ...
                                            ><?php echo e(__('Rate this Seller')); ?></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="seller-contact">
                                    <div class="locations">
                                        ...
                                        </svg> <span><?php echo userProfileLocation($user); ?></span>
                                    </div>
                                    <div class="emails">
                                    ...
                                    <div class="phones">
                                        ...
                                        </svg> <span><?php echo e($user->phone); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relevant-ads all-listings box-shadow1">
                            <h4 class="dis-title"><?php echo e(__('All Listing')); ?></h4>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.listings.relevant-ads-view','data' => ['listings' => $userListings]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['listings' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($userListings)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user.user-reviews','data' => ['reviews' => $user->reviews,'user' => $user,'reviewtype' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['reviews' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->reviews),'user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user),'reviewtype' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('frontend.pages.user.review-add-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(asset('assets/frontend/js/rating.js')); ?>"></script>
    <?php if (isset($component)) { $__componentOriginalba63a7e5156f528db525da14ce82036f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalba63a7e5156f528db525da14ce82036f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.listings.user-review-add-js','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('listings.user-review-add-js'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalba63a7e5156f528db525da14ce82036f)): ?>
<?php $attributes = $__attributesOriginalba63a7e5156f528db525da14ce82036f; ?>
<?php unset($__attributesOriginalba63a7e5156f528db525da14ce82036f); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalba63a7e5156f528db525da14ce82036f)): ?>
<?php $component = $__componentOriginalba63a7e5156f528db525da14ce82036f; ?>
<?php unset($__componentOriginalba63a7e5156f528db525da14ce82036f); ?>
<?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/frontend/pages/user/profile.blade.php ENDPATH**/ ?>