...
<script>
    (function ($) {
        ...
        function deleteImage(type){
            $.ajax({
                type: "POST",
                url: "<?php echo e(route($type.'.guest.upload.media.file.delete')); ?>",
                data: {
        ...
        $(document).on('click', '.img_alt_submit_btn', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route($type.'.guest.upload.media.file.alt.change')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        function loadAllImages() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route($type.'.guest.upload.media.file.all')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on('click','#loadmorewrap',function (){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route($type.'.guest.upload.media.file.loadmore')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    'skip' : skipp
                },
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/components/media/guest-js.blade.php ENDPATH**/ ?>