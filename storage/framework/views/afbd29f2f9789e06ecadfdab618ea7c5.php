<p class="featureCap d-flex align-items-center gap-1">
    <?php if(!empty($listing->address) && !is_null($listing->address)  || !empty($listing->country_id)): ?>
    ...
    <?php endif; ?>
    <span class="oneLine"> <?php echo e(userListingLocation($listing)); ?> </span>
</p>
<?php /**PATH /home/tutreqhl/beta.tutrouve.com/core/resources/views/components/listings/listing-location.blade.php ENDPATH**/ ?>