<div class="modal fade" id="renew_membership_modal" tabindex="-1" aria-labelledby="paymentGatewayModalLabel"
    ...
    <div class="modal-dialog">
        <form action="<?php echo e(route('user.membership.renew')); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="membership_id" id="membership_id">
            <?php echo csrf_field(); ?>
            <div class="modal-content">
                <div class="modal-header">
                    <?php if(Auth::guard('web')->check()): ?>
                       <h4><?php echo e(get_static_option('membership_renew_modal_title') ?? __('Renouvéller l\'abonnement')); ?></h4>
                    <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['description' => __('Avis : Veuillez vous connecter en tant qu\'utilisateur pour acheter un abonnement..')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Avis : Veuillez vous connecter en tant qu\'utilisateur pour acheter un abonnement..'))]); ?>
...
<?php endif; ?>
                ...
                <div class="modal-footer">
                    <div class="btn-wrapper">
                        <button type="button" class="btn-profile btn-outline-gray btn-hover-danger" data-bs-dismiss="modal"><?php echo e(__('Fermer')); ?></button>
                        <?php if(Auth::guard('web')->check()): ?>
                            <button type="submit" class="btn-profile btn-bg-1 buy_membership" id="confirm_buy_membership_load_spinner">
                                <?php echo e(__('Payer maintenant')); ?> <span id="buy_membership_load_spinner"></span>
                            </button>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php /**PATH /home/tutreqhl/public_html/core/Modules/Membership/resources/views/frontend/user/membership/renew-gateway-markup.blade.php ENDPATH**/ ?>