    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.user.identity.request.paginate.data').'?page='); ?>" + page,
                    success:function(res){
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.user.identity.request.search')); ?>",
                    method:'GET',
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/user/verification/verification-js.blade.php ENDPATH**/ ?>