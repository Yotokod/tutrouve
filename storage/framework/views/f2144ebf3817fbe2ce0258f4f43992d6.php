...
<div class="top-pic-part mb-3">
    ...
    <?php if(auth()->check() && Request::is('user/profile/settings')): ?>
...
<?php endif; ?>
<?php echo $__env->make('frontend.layout.partials.dashboard-notice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/frontend/user/layout/partials/user-profile-background-image.blade.php ENDPATH**/ ?>