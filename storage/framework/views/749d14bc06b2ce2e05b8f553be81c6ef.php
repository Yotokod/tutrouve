                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title"><?php echo e(__('All Advertisements')); ?></h4>
...
<?php endif; ?>
                        ...
                        <div class="dashboard__inner__header__right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('advertisement-add')): ?>
                               <a href="<?php echo e(route('admin.advertisement.new')); ?>" class="cmnBtn btn_5 btn_bg_blue radius-5"><?php echo e(__('Add Advertisement')); ?></a>
                            <?php endif; ?>
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_category_result">
                            <?php echo $__env->make('backend.pages.advertisement.search-advertisement', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.bulk-action-js','data' => ['url' => route('admin.advertisement.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
        ...
        (function(){
            ...
            $(document).ready(function(){
                ...
                $(document).on('keyup','.category_string_search',function(){
                    ...
                    $.ajax({
                        url:"<?php echo e(route('admin.advertisement.search')); ?>",
                        method:'GET',
                ...
                function notices(page,string_search){
                    $.ajax({
                        url:"<?php echo e(route('admin.advertisement.paginate').'?page='); ?>" + page,
                        data:{string_search:string_search},
                        success:function(res){
                            $('.search_category_result').html(res);
                        }
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/advertisement/index.blade.php ENDPATH**/ ?>