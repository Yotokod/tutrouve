                    ...
                    <section class="featureListing mb-5 mt-5">
                        <div class="container-1440">
                            <div class="titleWithBtn d-flex justify-content-between align-items-center mb-40">
                                <h4><?php echo e(sprintf(__('Annonces disponible'), $subcategory->name)); ?></h4>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutreqhl/public_html/core/resources/views/frontend/pages/listings/category/sub-category-wise-listings.blade.php ENDPATH**/ ?>