<script>
        $(document).ready(function () {
         ...
         function fetchDataCustomer(interval) {
          $.ajax({
           ...
           success: function(response) {
            ...
            let data = [];
            if (interval === '0') {
             labels = ["<?php echo e(__('Week 1')); ?>", "<?php echo e(__('Week 2')); ?>", "<?php echo e(__('Week 3')); ?>", "<?php echo e(__('Week 4')); ?>"];
            } else if (interval === '1') {
         ...
         function fetchDataListings(interval) {
          $.ajax({
           url: "<?php echo e(route('admin.get.listing.graph.data')); ?>",
           method: 'GET',
           data: { interval: interval },
           success: function(response) {
            let labels = [];
...
<?php /**PATH /home/tutreqhl/public_html/core/resources/views/backend/pages/dashboard/line-graph-js.blade.php ENDPATH**/ ?>