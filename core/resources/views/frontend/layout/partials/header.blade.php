<!DOCTYPE html>
<html     <link rel="stylesheet" href="{{ asset('assets/frontend/css/helpers.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/custom-styles.css') }}""{{get_user_lang()}}" dir="{{get_user_lang_direction()}}">
<head>
