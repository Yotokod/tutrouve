    ...
    <div class="container-1440">
        <div class="services-highlight-wrapper" style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: center;">
            ...
            <div class="services-image-section" style="position: relative;">
                @if($serviceListings->count() > 0)
                    <!-- Main Large Image -->
                    <div class="main-service-image" style="position: relative; border-radius: 24px; overflow: hidden; box-shadow: 0 20px 60px rgba(31, 62, 57, 0.15);">
                        {!! render_image_markup_by_attachment_id($serviceListings->first()->image, '', 'large') !!}
                ...
                @else
                    <div style="width: 100%; height: 500px; background: linear-gradient(135deg, rgba(31, 62, 57, 0.1), rgba(31, 62, 57, 0.05)); border-radius: 24px; display: flex; align-items: center; justify-content: center;">
                        <i class="las la-images" style="font-size: 64px; color: #cbd5e1;"></i>
                    </div>
                @endif
            </div>
