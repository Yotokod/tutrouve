            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 p-0 order-lg-1 order-1 loginLeft-img">
                    <div class="loginLeft-img">
                        <div class="login-cap">
                            <h3 class="tittle">{{ get_static_option('login_page_title') ?? __('Connexion') }}</h3>
                ...
                <div class="col-xl-7 col-lg-7 order-lg-1 order-0 login-Wrapper">
                    ...
                    <div class="row">
                        <form method="post" action="{{ route('user.login') }}">
                            @csrf
                            <div class="col-md-12">
                                <label class="infoTitle">{{ __('Email ou nom d\'utilisateur') }}</label>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-form">
                                    <input type="password" name="password" id="password" placeholder="{{ __('Saisir le mot de passe') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-wrapper form-icon">
                                                         <button type="button" class="red-btn user_login_demo_button autoLogin" id="userLogin">{{__('Login')}}</button>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
